...
const WordPress = () => {
  ...
  const services = [
    'Custom Theme Development', 'WooCommerce Integration', 'Plugin Customization', 'Speed Optimization',
    'SEO Setup', 'Security Hardening', 'Migration Services', 'Ongoing Maintenance',
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="hero-content">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">Professional <span className="gradient-text">WordPress</span> Solutions</h1>
              <p className="text-lg text-muted-foreground mb-8">From custom themes to complex plugins, we build WordPress websites that are fast, secure, and easy to manage.</p>
            ...
            <div className="hero-image"><img src={heroImage} alt="WordPress Development Services" className="w-full rounded-2xl shadow-2xl" /></div>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8">Comprehensive WordPress services to build, optimize, and maintain your website.</p>
            ...
            <div className="glass p-8 rounded-2xl">
              ...
              <Link to="/contact#contact-form"><Button className="w-full gradient-bg">Get a Custom Quote</Button></Link>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container-custom text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Let's build a WordPress website that drives results for your business.</p>
