...
const Squarespace = () => {
  ...
  const idealFor = [
    'Photographers', 'Artists & Creatives', 'Restaurants & Cafes', 'Small Businesses',
    'Consultants', 'Event Planners', 'Musicians & Bands', 'Real Estate Agents',
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="hero-content">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">Elegant <span className="gradient-text">Squarespace</span> Websites</h1>
              <p className="text-lg text-muted-foreground mb-8">Beautiful, minimalist Squarespace websites perfect for creatives, portfolios, and small businesses who want to look professional.</p>
            ...
            <div className="hero-image"><img src={heroImage} alt="Squarespace Development Services" className="w-full rounded-2xl shadow-2xl" /></div>
          </div>
        </div>
      </section>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-8">Squarespace is ideal for professionals and businesses who want elegant, easy-to-manage websites.</p>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container-custom text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Let's create a beautiful Squarespace website that showcases your work and attracts clients.</p>
