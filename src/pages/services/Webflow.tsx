    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="hero-content">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">Premium <span className="gradient-text">Webflow</span> Websites</h1>
              <p className="text-lg text-muted-foreground mb-8">Stunning, interactive Webflow websites with the power of custom code and the ease of visual design. No compromises.</p>
            ...
            <div className="hero-image"><img src={heroImage} alt="Webflow Development Services" className="w-full rounded-2xl shadow-2xl" /></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container-custom">
          <div className="glass p-12 rounded-2xl text-center max-w-2xl mx-auto">
            ...
            <Link to="/contact#contact-form"><Button size="lg" className="gradient-bg">Get a Custom Quote</Button></Link>
          </div>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container-custom text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Let's create a stunning Webflow site that sets you apart from the competition.</p>
