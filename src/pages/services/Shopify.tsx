    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="hero-content">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">Build Your <span className="gradient-text">Shopify Store</span> That Sells</h1>
              <p className="text-lg text-muted-foreground mb-8">Launch a powerful e-commerce store with Shopify. We create beautiful, high-converting online stores that grow your business.</p>
            ...
            <div className="hero-image"><img src={heroImage} alt="Shopify Development Services" className="w-full rounded-2xl shadow-2xl" /></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container-custom text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Let's build a Shopify store that showcases your products and drives sales.</p>
          <Link to="/contact#contact-form"><Button size="lg" className="gradient-bg">Start Your Store</Button></Link>
        </div>
      </section>
