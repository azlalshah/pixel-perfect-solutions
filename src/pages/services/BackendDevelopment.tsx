...
const BackendDevelopment = () => {
  ...
  const technologies = [
    { name: 'Node.js', category: 'Runtime' }, { name: 'Python', category: 'Language' },
    { name: 'PostgreSQL', category: 'Database' }, { name: 'MongoDB', category: 'Database' },
    { name: 'Redis', category: 'Caching' }, { name: 'Docker', category: 'Containers' },
    { name: 'GraphQL', category: 'API' }, { name: 'AWS/GCP', category: 'Cloud' },
  ];
    ...
    <div className="min-h-screen bg-background">
        ...
        <div className="container-custom relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="hero-content">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-heading font-bold mb-6">Robust <span className="gradient-text">Backend Systems</span> That Power Your Business</h1>
              <p className="text-lg text-muted-foreground mb-8">We build scalable, secure, and high-performance backend solutions that form the foundation of your digital products.</p>
            ...
            <div className="hero-image"><img src={heroImage} alt="Backend Development Services" className="w-full rounded-2xl shadow-2xl" /></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container-custom text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-xl mx-auto">Let's create a robust backend infrastructure that powers your application.</p>
